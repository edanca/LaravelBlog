...
class Conversation extends Model
{
	...
	public static function between(User $user, User $other) {
		...
		// The goal of this code is even if the conversation doesn't exist, always return a conversation
		...
		// If users already in the conversation, sync does not do anything
